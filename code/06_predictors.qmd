...
hipps <- hipps %>%
  mutate(
    race_eth_cat = fct_relevel(race_eth_cat, "White"),
    edu_cat = fct_relevel(edu_cat, "College graduate"),
    income_cat = fct_relevel(income_cat, "> 100k"),
    marital_status_cat = fct_relevel(marital_status_cat, "Married/partnered"),
    mom_age_cat = fct_relevel(mom_age_cat, "25-29 years"),
